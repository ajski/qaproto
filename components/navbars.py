...
class AbstractLegacyEmberNavbar(Navbar):
    user_dropdown = Locator(
        By.CSS_SELECTOR, "ul.navbar-nav > li:nth-child(6) > a", settings.LONG_TIMEOUT
    )
    sign_in_button = Locator(
        By.CSS_SELECTOR,
        "#secondary-navigation > ul.nav > li.ember-view.dropdown.sign-in > a.btn.btn-info.btn-top-login",
...
class EmberNavbar(HomeNavbar):
    user_dropdown = Locator(By.CSS_SELECTOR, "ul.navbar-nav > li:nth-child(6) > a")
    user_dropdown_profile = Locator(
        By.CSS_SELECTOR, "ul.auth-dropdown > li:nth-child(1)"
    )
    user_dropdown_support = Locator(
        By.CSS_SELECTOR, "ul.auth-dropdown > li:nth-child(2)"
    )
    user_dropdown_settings = Locator(
